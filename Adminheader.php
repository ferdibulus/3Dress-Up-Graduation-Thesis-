      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>3Dress-Up!</span></a>
          </div>
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="images/ferdibulus1.jpg" alt="..." class="img-circle profile_img">
            </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="">
            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              <img src="images/ferdibulus1.jpg" alt=""><?php echo $kullanicicek['kullanici_adsoyad'] ?>
          ...
          <li role="presentation" class="dropdown">
            ...
            <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
              <li>
                <a>
                  <span class="image"><img src="images/ferdibulus1.jpg" alt="Profile Image" /></span>
                  <span>
                    <span>Ferdi Bulus</span>
                    <span class="time">3 mins ago</span>
                  </span>
                  <span class="message">
                    Urunu 3Droom ile denedim ve cok memnun kaldim..
                  </span>
                </a>
              </li>
              <li>
                <a>
                  ...
                  <span class="message">
                    Bir sonraki alisverimide ayni sekilde yapmayi planliyorum. Tesekkurler..
                  </span>
                </a>
              </li>
              ...
              <li>
                <div class="text-center">
                  <a>
                    <strong>Butun mesajlari gor</strong>
