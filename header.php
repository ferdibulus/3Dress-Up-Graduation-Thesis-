    ...
    <body>
     <div id="wrapper">
      <div class="header"><!--Header -->
       <div class="container">
        <div class="row">
         <div class="col-xs-6 col-md-4 main-logo animated fadeInLeft">
 ...
 <div class="navbar navbar-default navbar-static-top">
  ...
  <?php 
      ...
      while($sepetcek1=$sepetsor1->fetch(PDO::FETCH_ASSOC)) {
        ...
        $urunsor1=$db->prepare("SELECT * FROM urun where urun_id=:urun_id");
        $urunsor1->execute(array(
          'urun_id' => $urun_id
          ));

        $uruncek1=$urunsor1->fetch(PDO::FETCH_ASSOC);
        $toplam_fiyat1+=$uruncek1['urun_fiyat']*$sepetcek1['urun_adet'];
        ?>
  ...
  <div class="col-md-2 machart" >
   <button id="popcart" class="btn btn-default btn-chart btn-sm "><span class="mychart">Alışveriş Sepeti</span>|<span class="allprice"><?php echo $toplam_fiyat1 ?>TL</span></button>
   <div class="popcart">
  ...
  <div class="btn-popcart">
   ...
   <a href="3dindex.php" class="btn btn-default btn-red btn-sm">3D Room</a>
 </div>
